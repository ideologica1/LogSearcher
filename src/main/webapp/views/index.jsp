...
<div class="form">
    ...
    <form method="POST" action="form/show" id="search-form">
        <div class="form-group">
            <label for="regEx">Введите регулярное выражение: </label>
            <input type="text" class="form-control w-25 border-dark" id="regex" name="regex"
                   aria-describedby="emailHelp"
                   placeholder="Регулярное выражение"/>
        </div>

        <div class="command-buttons">
            <button type="button" class="btn btn-warning w-100" data-toggle="modal" data-target="#pallete">Открыть
                палитру
            </button>
            <p></p>
        ...
        <div class="form-group w-75" id="here" style="display: inline-block;">
            <div class="row w-100 date-interval" id="dateintervals">
                ...
                <div class="col w-25 buttons">
                    ...
                    <button type="button" id="button-add" class="btn btn-success add-interval"
                            onclick="addDateInterval(this)">Добавить
                    </button>
                </div>
            </div>
        </div>
        ...
        <button type="button" class="btn btn-danger exit-button" data-toggle="modal" data-target="#confimation">Выход
        </button>


        <div class="modal fade bd-example-modal-lg" id="pallete" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row w-100 pallette-buttons">
                            <div class="col ">
                                <button type="button" class="btn  w-100 b4ffff-button" onclick="switchColor('#b4f0f0')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col ">
                                <button type="button" class="btn  w-100 b4b4ff-button" onclick="switchColor('#b4b4ff')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col ">
                                <button type="button" class="btn  w-100 b4c8ff-button" onclick="switchColor('#b4c8ff')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn  w-100 b4ffc8-button" onclick="switchColor('#b4ffc8')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                        </div>
                        <div class="row w-100 pallette-buttons">
                            <div class="col">
                                <button type="button" class="btn w-100 ccb7cc-button" onclick="switchColor('#ccb7cc')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn w-100 f2b8f2-button" onclick="switchColor('#f2b8f2')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn w-100 b8b6bd-button" onclick="switchColor('#b8b6bd')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn w-100 f2f0b4-button" onclick="switchColor('#f2f0b4')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                        </div>
                        <div class="row w-100 pallette-buttons">
                            <div class="col w-25">
                                <button type="button" class="btn  w-100 f5d0ba-button" onclick="switchColor('#f5d0ba')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col w-25">
                                <button type="button" class="btn  w-100 c5dbbf-button" onclick="switchColor('#c5dbbf')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col w-25">
                                <button type="button" class="btn  w-100 ffedcc-button" onclick="switchColor('#ffedcc')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn  w-100 fae6c8-button" onclick="switchColor('#fae6c8')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                        </div>
                        <div class="row w-100 pallette-buttons">
                            <div class="col">
                                <button type="button" class="btn  w-100 f0fadc-button" onclick="switchColor('#f0fadc')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn  w-100 f2f0c8-button" onclick="switchColor('#f2f0c8')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn  w-100 b4f0f0-button" onclick="switchColor('#b4f0f0')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn  w-100 e9fab4-button" onclick="switchColor('#e9fab4')"
                                        data-dismiss="modal">Choose
                                </button>
                            </div>
                        </div>
    ...
    <div class="modal fade bd-example-modal-sm" id="confimation" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
